...
*  Title:           MyVector Program
*  Course:           2143-OOP
*  Semester:         Fall 2021
*
*  Description:
*        This assignment is an illustration of vector functionalities by the linked list implementation. It uses the segements of codes, as 
*          resource, provided by instructor.
*  Usage:
*              It shows how to use the  functions and the program of MyVector.
*/
